...
# cantidad de lineas originales: 150 aprox
# última actualización: 31 / 07 / 25 hora 14:05
# motivo de la actualización: corregido PG_DB_NAME, limpieza de logs y formato final
...
# 🔹 Detecta sistema operativo y ruta
...
# 🟡 Si estamos en Windows con espacios en la ruta, usamos el .bat oficial
...
# 🔹 Si ruta segura o Linux/Mac → ejecución en Python
PG_USER = os.getenv("PG_USER", "postgres")
PG_PASSWORD = os.getenv("PG_PASSWORD", "")
PG_HOST = os.getenv("PG_HOST", "localhost")
PG_PORT = os.getenv("PG_PORT", "5432")
PG_DB_NAME = os.getenv("PG_DB_NAME", "software_notarios")  # Base de datos oficial
