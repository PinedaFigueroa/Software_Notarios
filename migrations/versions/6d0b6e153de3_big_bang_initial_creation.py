...
Revision ID: 6d0b6e153de3
Revises: 
Create Date: 2025-07-31 13:55:36.265541
...
def upgrade():
    ...
    sa.Column('forma_pago', sa.Enum('EFECTIVO', 'TRANSFERENCIA', 'TARJETA', 'DEBITO', 'CREDITO', name='formapagoenum'), nullable=False),
    ...
    sa.Column('rol', sa.Enum('SUPERADMIN', 'ADMIN_LOCAL', 'NOTARIO', 'PROCURADOR', 'ASISTENTE', name='rolusuarioenum'), nullable=False),
    sa.Column('estado', sa.Enum('ACTIVO', 'INACTIVO', 'BLOQUEADO', name='estadousuarioenum'), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('tipo_documento', sa.Enum('ESCRITURA', 'ACTA', 'TESTIMONIO', name='tipodocumentoenum'), nullable=False),
    ...
    sa.Column('estado_documento', sa.Enum('BORRADOR', 'FIRMADO', 'ENTREGADO', name='estadodocumentoenum'), nullable=False),
